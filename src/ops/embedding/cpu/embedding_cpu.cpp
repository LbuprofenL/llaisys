...
template <typename T>
void embedding_(T *out, const size_t *index, const T *weight, const size_t idx_numel,const size_t dim0,const size_t dim1) {
   // 每行拷贝的字节数
...
void embedding(std::byte *out, const std::byte *index, const std::byte *weight,llaisysDataType_t type, const size_t idx_numel,const size_t dim0,const size_t dim1) {
    switch (type) {
