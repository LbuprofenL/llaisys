...
template <typename T>
void linear_(T *out, const size_t *index, const T *weight,
...
void embedding(std::byte *out, const std::byte *index, const std::byte *weight,
    ...
    case LLAISYS_DTYPE_F32:
        return linear_(reinterpret_cast<float *>(out), reinterpret_cast<const size_t *>(index),
                          reinterpret_cast<const float *>(weight), idx_numel, dim0, dim1);
    case LLAISYS_DTYPE_BF16:
        return linear_(reinterpret_cast<llaisys::bf16_t *>(out), reinterpret_cast<const size_t *>(index),
                          reinterpret_cast<const llaisys::bf16_t *>(weight), idx_numel, dim0, dim1);
    case LLAISYS_DTYPE_F16:
        return linear_(reinterpret_cast<llaisys::fp16_t *>(out), reinterpret_cast<const size_t *>(index),
